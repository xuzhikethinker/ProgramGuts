...
public class BuilderDebugger {
	...
	//int VectorCount = 0; -> only need if we can call stack trace on an external program
	...
	public void DebugProgram() {
            ...
            //AddObjectNode(getClassName()); -> use only if we can get a stack trace for Interesting.Java
...
/*
    public String getClassName() {
        ...
        String className = new Exception().getStackTrace()[VectorCount].getClassName().toString();
     ...
     public String getMethodName() {
        ...
        String MethodName = new Exception().getStackTrace()[VectorCount].getMethodName().toString();
 ...
 */
     ...
     public void makeNodes() {
        ...
        {
            //ObjectNode objcon1 = new ObjectNode(constructor.getName()); -> tried to make and objectnode that 
            //would help make the connection commented out below
            ...
            for (Method method : methods1)
            {
                ...
                if(method == methods1[0]){
                AddFunctionNode(f,method.getName());
        ...
        //Nested loop through the constructors (then methods) and puts the in constructors in object nodes
        // and the methods in function nodes
        for (Constructor constructor : cons2)
        {
            ...
            // Loop through methods and puts them in function nodes
